...
Def.publish = { ...
    ...
    'author','',@ischar, ...
    'cleanup,deletelatex,deletetempfiles',true,@(isArg)is.logicalscalar(isArg), ...
    'compile',true,@(isArg)is.logicalscalar(isArg), ...
    'date','\today',@ischar, ...
    ...
    'textscale,scale',0.8,@(isArg)is.numericscalar(isArg), ...
    'tempdir',@() tempname(pwd()),@(x) is.func(x) || ischar(x), ...
    };
