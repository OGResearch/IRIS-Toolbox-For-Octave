...
Def.mychksstate = { ...
    'sstateeqtn',false,@is.logicalscalar, ...
...
Def.model = {
    ...
    'comment','',@ischar, ...
    'optimal','consistent',@(x) any(strncmpi(x,{'consis','commit'},6)), ...
...
Def.solve = { ...
    ...
    'linear','auto',@(x) is.logicalscalar(x) ...
    || (ischar(x) && strcmpi(x,'auto')), ...
    'logbook',false,@is.logicalscalar, ...
    'error',false,@is.logicalscalar, ...
