...
Def.infline = {
    caption{:}, ...
    'excludefromlegend',true,@(varargin)is.logicalscalar(varargin{:}), ...
    'timeposition','middle',@(x) is.anychari(x,{'middle','before','after'}), ...
    }; %#ok<CCAT>

Def.highlight = { ...
    caption{:}, ...
    'around',NaN,@(varargin)is.numericscalar(varargin{:}), ...
...
Def.plotcircle = { ...
    'fill',false,@(varargin)is.logicalscalar(varargin{:}), ...
    };

Def.ploteig = { ...
    'ucircle,unitcircle',true,@(varargin)is.logicalscalar(varargin{:}), ...
    'quadrants',true,@(varargin)is.logicalscalar(varargin{:}), ...
    };

Def.plotmat = { ...
    'colnames,colname','auto',@(x) isempty(x) || iscellstr(x) || ischar(x), ...
    'rownames,rowname','auto',@(x) isempty(x) || iscellstr(x) || ischar(x), ...
    'maxcircle',false,@(varargin)is.logicalscalar(varargin{:}), ...
    'naninf','X',@(x) ischar(x) && length(x) == 1, ...
    'scale','auto',@(x) (ischar(x) && strcmpi(x,'auto')) ...
    || (is.numericscalar(x) && x > 0), ...
    'showdiag',true,@(varargin)is.logicalscalar(varargin{:}), ...
...
Def.plotneigh = { ...
    ...
    'linkaxes',false,@(varargin)is.logicalscalar(varargin{:}), ...
    };
...
Def.plotpp = { ...
    ...
    'tight',true,@(varargin)is.logicalscalar(varargin{:}), ...
...
Def.fsection = { ...
    'close',false,@(varargin)is.logicalscalar(varargin{:}), ...
    'addto','',@ischar, ...
