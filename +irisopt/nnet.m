...
Def.nnet = { ...
    ...
    'initBias', 0, @(x) isnumericscalar(x) || isfunc(x), ...
    'initWeight,initWeights', 0, @(x) isnumericscalar(x) || isfunc(x), ...
    'initActivation', 1, @(x) isnumericscalar(x) || isfunc(x), ...
	'initOutput', 0, @(x) isnumericscalar(x) || isfunc(x), ...
    } ;
