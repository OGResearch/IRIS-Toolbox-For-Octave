...
% parallelised pre-fetching will be used; `'firstPrefetch='` must be
% greater than `'lastAdapt='`; `Inf` means no pre-fetching.
%
...
% covariance will be adapted; adaptation must be stopped before
% pre-fetching starts; `Inf` means adaptation will continue until the last
% draw.
%
