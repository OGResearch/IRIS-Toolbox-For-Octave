    ...
    methods
        ...
        function This = seriesobj(varargin)
            ...
            This.default = [This.default,{ ...
                ...
                true, ...
                'decimal',NaN,@(varargin)is.numericscalar(varargin{:}),true, ...
                'format','%.2f',@ischar,true, ...
                'highlight',[], ...
                @(x) isempty(x) || isnumeric(x) || is.func(x), ...
                false, ...
                ...
                'plotfunc',@plot,@(x) is.func(x) ...
                && any(strcmpi(mychar(x),{'plot','area','bar','conbar', ...
                ...
                'round',Inf,@(x) is.intscalar(x),true, ...
        ...
        function [This,varargin] = specargin(This,varargin)
            if ~isempty(varargin)
                if is.tseries(varargin{1}) || iscell(varargin{1})
                    This.data = varargin{1};
                    if is.tseries(This.data)
                        This.data = {This.data};
                    end
                end
                varargin(1) = [];
        ...
        function This = setoptions(This,varargin)
            ...
            if strcmp(mychar(This.options.plotfunc),'conbar')
