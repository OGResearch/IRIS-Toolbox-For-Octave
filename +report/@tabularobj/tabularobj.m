    ...
    methods
        ...
        function This = tabularobj(varargin)
            ...
            This.default = [This.default, { ...
                'arraystretch',1.15,@(x) is.numericscalar(x) && x > 0,true, ...
                'colspec','',@ischar,true, ...                
                'colwidth',NaN,@isnumeric,true, ...
                'long',false,@(varargin)is.logicalscalar(varargin{:}),true, ...
                'longfoot','',@ischar,true, ...
                'longfootposition','l', ...
                    @(x) ischar(x) && any(strncmpi(x,{'l','c','r'},1)),true, ...
                'sideways',false,@(varargin)is.logicalscalar(varargin{:}),true, ...
                'tabcolsep',NaN,@(x) is.numericscalar(x) && (isnan(x) || x >= 0), true, ...
            }];
        end
