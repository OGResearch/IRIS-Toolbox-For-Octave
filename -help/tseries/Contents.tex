    ...
    \foldertitle{tseries}{Time Series (Tseries) Objects and Functions}{tseries/Contents}
...
objects}\label{getting-information-about-tseries-objects}
...
objects}\label{referencing-tseries-objects}
