...
\paragraph{Input parameters}\label{input-parameters}
...
\paragraph{Equations and assignments}\label{equations-and-assignments}
...
positive}\label{variables-with-steady-state-restricted-to-be-positive}
