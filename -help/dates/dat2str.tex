...
\subparagraph{Year-period date strings}\label{year-period-date-strings}
...
\subparagraph{Calendar date strings}\label{calendar-date-strings}
...
\subparagraph{Escaping control letters}\label{escaping-control-letters}
